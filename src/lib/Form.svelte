            ...
            <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
                ...
                <form action="#">
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                        ...
                        <div>
                            <label for="category" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Job Type</label>
                            <select id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                <option selected="">Select Job Type</option>
                                <option value="VS">Visa Sponsorship</option>
                                <option value="RS">Relocation Support</option>
                            </select>
                        </div>
                        <div class="w-full">
                        ...
                        <div class="sm:col-span-2">
                            <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Application Link or Email </label>
