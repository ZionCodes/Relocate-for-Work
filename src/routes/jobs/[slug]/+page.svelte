  ...
  <div class="min-w-0 flex-1">
    ...
    <div class="mt-1 flex flex-col sm:mt-0 sm:flex-wrap">
      ...
      <div class="mt-2 flex items-center text-sm text-gray-500">
        ...
        {data.records.city}, {data.records.country}
      </div>
      <!-- <div class="mt-2 flex items-center text-sm text-gray-500">
        <svg class="mr-1.5 h-5 w-5 flex-shrink-0 text-gray-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
      ...
      <div class="mt-2 flex items-center text-sm text-gray-500">
        <svg class="mr-1.5 h-5 w-5 flex-shrink-0 text-gray-400" viewBox="0 0 20 20" fill="none" aria-hidden="true">
          <path fill-rule="evenodd" d="M15.583 8.445h.01M10.86 19.71l-6.573-6.63a.993.993 0 0 1 0-1.4l7.329-7.394A.98.98 0 0 1 12.31 4l5.734.007A1.968 1.968 0 0 1 20 5.983v5.5a.992.992 0 0 1-.316.727l-7.44 7.5a.974.974 0 0 1-1.384.001Z" clip-rule="evenodd"/>
        </svg>        
